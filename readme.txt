...
Easily tracks how many daily social interactions you have on these social networks: Facebook, Twitter, Google+, Linkedin, Pinterest, Vk. With widget.
...
This plugin is the free version of a more complete plugin available for purchase ($18 on CodeCanyon.net).
It's quick and painless to get the complete version (if you want to upgrade from Free version.) Simply get [Top Social Stories on CodeCanyon](http://codecanyon.net/item/top-social-stories-plugin-and-widget/5888553?ref=ginoplusio) remove the Free plugin and install your new plugin! You can then see charts of collected data, and use many more settings & features and enjoy the benefits of the complete version such as the authors'rank widget, shortcodes and more!

== Installation ==

1. Upload the "top-stories" directory in your "/wp-content/plugins/" directory
